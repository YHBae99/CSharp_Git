...
ORDER BY ID DESC";
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (SFDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Excelexport.enExportType enType = Excelexport.enExportType.EXCEL_COM;
                //Excelexport.enExportType enType = Excelexport.enExportType.OLEDB_EXCEL;
                //Excelexport.enExportType enType = Excelexport.enExportType.CSV_STREAM;
