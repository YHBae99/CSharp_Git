...
namespace _01_Excption2
{
    ...
    {
        Dictionary<string, Color> dColor = new Dictionary<string, Color>();  // Dictionary에 색상정보를 저장
        Color oSelectColor = new Color();   // 현재 선택 된 색 정보를 가지고 있을 변수
        ...
        {
            DialogResult dRet = cDialogColor.ShowDialog();  // ColorDialog를 불러서 선택한 뒤 결과 값까지 받음

            if (dRet == DialogResult.OK)   //결과 값이 정상일 때 선택 된 Color를 Panel에 저장
            {
        ...
        {
            pColor.BackColor = Color.FromArgb(tbarAlpha.Value, pColor.BackColor);  // 색상 값에 Alpha 값을 변경해서 다시 저장
            lblColorinfo.Text = pColor.BackColor.ToString();
        }


        /// <summary>
        /// 저장 Button을 Click 했을 경우 선택 색상을 사전에 저장 한 뒤 사전에 있는 값을 List에 저장
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// 삭제 Button을 Click 했을 경우 List에서 선택된 값과 같은 key를 가진 사전에 있는 값을 삭제 한뒤 List를 다시 저장
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// ListBox의 선택 값이 변경 되면 변경 된 선택 값의 색상 정보를 oSelectColor 변수에 저장
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// 그림 판에 있는 Panel 중 선택 된 Panel에 대해서 저장한 색상 정보를 기준으로 다시 그림
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
